...
namespace com.intime.fashion.data.sync.Tmall
{
    public class ConstValue
    {
        ...
        public static string TOP_APP_KEY = ConfigurationManager.AppSettings["TOP_APP_KEY"] ?? "230216681";

        public static string TOP_APP_SECRET = ConfigurationManager.AppSettings["TOP_APP_SECRET"] ?? "baf0dcd2f1ee89159dcccfab0db3368f1";

        public static string TOP_SESSION_KEY = ConfigurationManager.AppSettings["TOP_SESSION_KEY"] ?? "6101827124a157b78801f2b9d11bc9e0c2c1f3a2b4c2f5e22473964851";
