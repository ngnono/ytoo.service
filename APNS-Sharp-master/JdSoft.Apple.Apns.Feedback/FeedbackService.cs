...
namespace JdSoft.Apple.Apns.Feedback
{
    ...
    public class FeedbackService : IDisposable
    {
        ...
        public FeedbackService(string host, int port, byte[] p12FileBytes)
        {
            ...
            certificate = new X509Certificate2(p12FileBytes, new SecureString(), X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.Exportable);
