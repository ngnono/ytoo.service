...
namespace CustomControlLibrary
{
    ...
    public partial class DataPager : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty PageSizeListProperty =
            DependencyProperty.Register("PageSizeList", typeof (string), typeof (DataPager),
                new UIPropertyMetadata("5,10,20", (s, e) =>
                {
                    var dp = s as DataPager;
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register("ItemsSource", typeof (IEnumerable<object>), typeof (DataPager),
        ...
        private void RaisePageChanged()
        {
            ...
            {
                pageChangedEventArgs.PageSize = PageSize;
                pageChangedEventArgs.PageIndex = PageIndex;
            }
