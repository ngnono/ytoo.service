...
{
    [Export(typeof(CustomerReturnGoodsUserControlViewModel))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class CustomerReturnGoodsUserControlViewModel : BindableBase
    {
        ...
        public CustomerReturnGoodsUserControlViewModel()
        {
