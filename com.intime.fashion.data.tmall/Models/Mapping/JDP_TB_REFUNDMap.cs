...
{
    public class JDP_TB_REFUNDMap : EntityTypeConfiguration<JDP_TB_REFUND>
    {
        public JDP_TB_REFUNDMap()
        {
            // Primary Key
            this.HasKey(t => new { t.refund_id, t.status, t.seller_nick, t.buyer_nick, t.tid, t.oid, t.created, t.modified, t.jdp_created, t.jdp_modified, t.jdp_hashcode, t.jdp_response });

            // Properties
            this.Property(t => t.refund_id)
            ...
            this.ToTable("JDP_TB_REFUND");
            this.Property(t => t.refund_id).HasColumnName("refund_id");
