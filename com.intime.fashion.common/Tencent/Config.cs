...
namespace com.intime.fashion.common.Tencent
{
    ...
    {
        public static readonly string OP_CODE = ConfigurationManager.AppSettings["TECENT_OP_CODE"];
        public static readonly string OP_NAME = ConfigurationManager.AppSettings["TECENT_OP_NAME"];
