...
namespace Com.Alipay
{
    ...
    public class Config
    {
        ...
        static Config()
        {
            ...
            partner = ConfigurationManager.AppSettings["Ali_partner"];

            //商户的私钥
            private_key = ConfigurationManager.AppSettings["Ali_privatekey"];
        ...
        {
            get {
                return ConfigurationManager.AppSettings["Ali_paymentcode"];
            }
        }
        #endregion
    }
