...
namespace Yintai.Hangzhou.Cms.WebSiteTest.Util
{
    ...
    public class UploadHandler : IHttpHandler
    {
        ...
        private void UploadOrDeleteFile(HttpContext context)
        {
            string requestType = context.Request.QueryString["t"];
            if (requestType != null &&
                requestType.Trim().Equals("DELETE", System.StringComparison.InvariantCultureIgnoreCase))
                DeleteFile(context);
            else
                UploadFile(context);
        }
