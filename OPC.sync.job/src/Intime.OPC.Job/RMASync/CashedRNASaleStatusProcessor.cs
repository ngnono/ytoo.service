...
{
    public class CashedRNASaleStatusProcessor : AbstractRMASaleStatusProcessor
    {
         private static readonly ILog Log = LogManager.GetCurrentClassLogger();
         public CashedRNASaleStatusProcessor(EnumRMAStatus status) : base(status) { }
        ...
        public override void Process(string rmaNo, OrderStatusResultDto statusResult)
        {
            ...
            using (var db = new YintaiHZhouContext())
            {
                ...
                //saleRMA.UpdatedUser = SystemDefine.SystemUser;
                saleRMA.Status = (int)_status;
                //saleRMA.CashNum = statusResult.PosSeqNo;
                //saleRMA.CashDate = statusResult.PosTime;
