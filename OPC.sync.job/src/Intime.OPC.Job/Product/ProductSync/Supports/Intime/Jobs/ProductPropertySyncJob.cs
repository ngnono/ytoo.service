...
using PropertyValue = Intime.O2O.ApiClient.Domain.PropertyValue;
...
namespace Intime.OPC.Job.Product.ProductSync.Supports.Intime.Jobs
{
    ...
    public class ProductPropertySyncJob : IJob
    {
        ...
        public void Sync(DateTime benchDate, DateTime lastUpdateDateTime)
        {
            ...
            {
                var properties =
                    _remoteRepository.GetProductProperties(pageIndex++, PageSize, lastUpdateDateTime);
        ...
        private void Process(PropertyValue p, DateTime benchDate)
        {
