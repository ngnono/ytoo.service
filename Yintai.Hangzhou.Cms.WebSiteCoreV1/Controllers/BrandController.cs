...
namespace Yintai.Hangzhou.Cms.WebSiteCoreV1.Controllers
{
    ...
    public class BrandController : UserController
    {
        ...
        {
            return Json(_brandRepository.AutoComplete(name).Where(entity => entity.Status != (int)DataStatus.Deleted && (string.IsNullOrEmpty(name) ? true : entity.Name.StartsWith(name.Trim()))).Take(10)
