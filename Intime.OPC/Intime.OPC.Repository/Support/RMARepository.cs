...
namespace Intime.OPC.Repository.Support
{
    public class RMARepository : BaseRepository<OPC_RMA>, IRMARepository
    {
        ...
        public PageResult<RMADto> GetAll(string orderNo, string saleOrderNo, DateTime startTime, DateTime endTime,
            EnumRMAStatus rmaStatus, EnumReturnGoodsStatus returnGoodsStatus, int pageIdex, int pageSize)
        {
            ...
            using (var db = new YintaiHZhouContext())
            {
                ...
                var lst2 = query.Join(db.OPC_SaleRMA.Where(e => e.Status == status && e.RMAStatus == des), o => o.RMANo,
