...
using com.intime.fashion.data.ims.Models.Mapping;

namespace com.intime.fashion.data.ims.Models
{
    public partial class YintaiHangzhouContext : DbContext
    {
        ...
        public DbSet<InventoryBackupEntity> InventoryBackups { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new InventoryBackupEntityMap());
            ...
            modelBuilder.Configurations.Add(new PropertyValueEntityMap());
