...
namespace Yintai.Architecture.Framework.ServiceLocation
{
    ...
    public interface IServiceLocator
    {
        ...
        /// 向容器中注册类型之前触发该事件
        /// </summary>
        event EventHandler<ServiceEventArgs> Registering;

        /// <summary>
        /// 向容器中注册类型之后触发该事件
        /// </summary>
        event EventHandler<ServiceEventArgs> Registered;

        /// <summary>
        /// 向容器中获取类型之前触发该事件
        /// </summary>
        event EventHandler<ServiceEventArgs> Resolving;

        /// <summary>
        /// 向容器中获取类型之后触发该事件
        /// </summary>
        event EventHandler<ServiceEventArgs> Resolved;
